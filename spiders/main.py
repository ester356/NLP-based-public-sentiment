from spiders.spiderContent import start as spiderContentStart, start_2
from spiders.spiderComments import start as spiderCommentsStart
from spiders.globalVariable import *
...
def main(types=[], page=0):
    ...
    from BERT.analysis_comments import main as sentimentAnalysis
    print('开始分析评论情感')
...
if __name__ == '__main__':
    # 使用相对路径
    emotion_ratio('spiders/data/articleContent.csv',
                  'spiders/data/articleComments.csv')